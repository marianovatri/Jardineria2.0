  ...
  data() {
    return {
      ...
      services: [
        {
          id: 4,
          image: url('../assets/CORTECESPED.jpeg'),
          alt: 'CORTE DE CÉSPED',
        ...
        {
          id: 6,
          image: url("../assets/LIMPIEZA.jpeg"),
        ...
        {
          id: 5,
          image: url("../assets/JARDINSECO.jpeg"),
          alt: 'JARDÍN SECO',
